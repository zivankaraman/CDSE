...
numerous data processing tools. In particular, the 'Sentinel Hub' API
...
`GetOAuthClient` function, and to pass it as the `client` argument to
the functions requiring the authentication. For more detailed
information, you are invited to consult the `"Before you start"`
document.
...
<https://github.com/zivankaraman/CDSE/issues>

## Author

Zivan Karaman \<zivan.karaman@gmail.com\>
